...
import { getWaitStaffAssignmentById } from 'apiSdk/wait-staff-assignments';
...
function WaitStaffAssignmentViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Wait Staff Assignment Detail View
          </Text>
          {hasAccess('wait_staff_assignment', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/wait-staff-assignments/edit/${data?.id}`} passHref legacyBehavior>
              <Button
